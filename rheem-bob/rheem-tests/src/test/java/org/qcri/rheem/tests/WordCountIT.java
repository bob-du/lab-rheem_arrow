...
public class WordCountIT {
    ...
    public void testOnSparkToJava() throws URISyntaxException, IOException {
        ...
        // for each line (input) output an iterator of the words 对于每一行(输入)输出一个单词的迭代器,split分割
        ...
        // for each word transform it to lowercase and output a key-value pair (word, 1)对于每个单词，将其转换为小写形式并输出一个键-值对(word, 1)
        ...
        // write results to a sink 将结果写入sink
        List<Tuple2> results = new ArrayList<>();
