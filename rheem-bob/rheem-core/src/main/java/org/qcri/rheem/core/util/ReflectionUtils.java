...
/**
 * Utilities for reflection code.用于反射代码的实用程序。
 */
public class ReflectionUtils {
     ...
     * 指定并返回JAR文件，该文件声明给定的{@code对象}的{@link类}，如果无法确定该文件，则声明{@code空}或{@code空}。
     */
     ...
     * 如果无法确定给定的{@link Class}，则标识并返回声明该给定{@link Class}的JAR文件。
     */
